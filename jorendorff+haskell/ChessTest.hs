...
main = do
  ...
  -- En passant can be a legal move in this situation???
  (do let board = fenToBoard "4k3/pp2pp2/2p2r2/3pP2b/1P1B1P2/2PQP3/P6P/2KR4 w - d6 0 38"
      putStrLn (show board)
      assertLegalMove board "e5d6" "en passant yes good good")
  ...
  (do let board = fenToBoard "4k3/pp2pp2/2p2r2/3pP2b/1P1BKP2/2PQP3/P6P/3R4 w - d6 0 38"
      ...
      putStrLn $ show $ scoreFinishedGame board)
  ...
  -- Require that the AI recognize an en passant that produces a discovery fork
  -- TODO
